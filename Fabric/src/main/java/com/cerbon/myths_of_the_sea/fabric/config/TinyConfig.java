package com.cerbon.myths_of_the_sea.fabric.config;
...
public class TinyConfig {
    ...
    public static void init(String modid, String modname, Class<?> config) {
        Gson gson = (new GsonBuilder()).excludeFieldsWithModifiers(128).excludeFieldsWithModifiers(2).setPrettyPrinting().create();
        ...
        try {
            ...
            try {
                ...
                Files.write(path, gson.toJson(config.newInstance()).getBytes());
