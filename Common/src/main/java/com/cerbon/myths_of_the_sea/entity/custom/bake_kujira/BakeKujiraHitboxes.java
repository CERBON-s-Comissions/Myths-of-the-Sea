...
public class BakeKujiraHitboxes {
    private final BakeKujiraEntity entity;
    ...
    private final EntityBounds hitboxes = EntityBounds.builder()
            ...
            .add(mainBox).setBounds(1.0, 1.2, 7.0).setOffset(0.0, 0.7, -0.25).setParent(rootBoxYaw).build()
            .overrideCollisionBox(collisionHitbox)
            .getFactory().create();

    public BakeKujiraHitboxes(BakeKujiraEntity entity) {
        this.entity = entity;
    }
